    ...
    <article className="border border-gray-300 rounded-xl overflow-hidden">
      ...
      <div className="details-wrapper p-3">
        ...
        <small className="text-base block my-2">
          Sold by <span className="font-semibold text-primary-green">Aatmane</span>
        </small>
        <div className="flex justify-between items-center">
          <div className="pricing-discount flex items-end gap-4">
            <div className="pricing">
              ...
              <del className="prev-price text-neutral-black-light/60">609,00Dh</del>
            </div>
            <span className="discount bg-primary-cerise rounded-md text-neutral-white py-1 px-3 text-sm mb-[6px]">-26%</span>
          </div>
